    ...
    const fetchCategories = async () => {
      try {
        const response = await fetch(
          `http://31.97.41.27:5000/api/styles/titles`
        );
    ...
    <footer className="bg-[#0a3764] text-white pt-12 pb-6 px-4 md:px-8 lg:px-16">
      <div className="max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-blue-900 pb-10">
          {/* Contact Info */}
          <div>
            <h3 className="tracking-widest text-sm font-semibold mb-4">
          ...
          <div className="flex flex-col items-end justify-between h-full">
            <div className="flex gap-3 mb-4">
              <a
                href="#"
                aria-label="Facebook"
                className="bg-white/10 rounded p-2 hover:bg-white/20"
              >
                <Facebook size={24} />
              </a>
              <a
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 gap-4 text-xs text-gray-400">
          ...
          <div className="flex space-x-6">
            <a
              href="#"
              className="hover:text-[#b3ddf3] transition-colors duration-200"
            >
              Terms
            </a>
            <a

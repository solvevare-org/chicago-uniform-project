...
import { Search, Bell, ShoppingBag, Heart } from 'lucide-react';
        ...
        <div className="bg-gradient-to-r from-[#121212] via-[#1A1A1A] to-[#121212] text-white py-4 px-6 md:px-8 shadow-lg">
          <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-6">
                <button aria-label="Wishlist" className="text-white hover:text-green-400 transition-transform transform hover:scale-110">
                  <Link to="/wishlist">
                    <Heart size={20} />
                  </Link>
                </button>

...
const HomeBrandGrid: React.FC = () => {
  ...
  if (loading) return <div className="text-gray-400 px-4 py-8">Loading brands...</div>;
  if (!brands || brands.length === 0) return <div className="text-red-400 px-4 py-8">No brands found.</div>;

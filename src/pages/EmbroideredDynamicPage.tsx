    ...
    <div className="min-h-screen bg-white text-[#222] py-12 px-4 md:px-6 lg:px-8">
      <div className="max-w-screen-2xl mx-auto">
        ...
        {embroideredType === 'hoodie' && (
          <h1 className="text-3xl font-bold mb-4 text-[#3ab7ea]">Custom Embroidered Hoodies</h1>
        )}
        {embroideredType === 't-shirt' && (
          <h1 className="text-3xl font-bold mb-4 text-[#3ab7ea]">Custom Embroidered T-Shirts</h1>
        )}
        {embroideredType === 'sweatshirt' && (
          <h1 className="text-3xl font-bold mb-4 text-[#3ab7ea]">Custom Embroidered Sweatshirts</h1>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-3 grid gap-8" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
            {loading ? (

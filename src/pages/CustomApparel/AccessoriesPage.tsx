...
const fetchAllAccessoriesProducts = async (): Promise<any[]> => {
  try {
    const allProducts = [];
    
    for (const subcategory of ACCESSORIES_SUBCATEGORIES) {
      try {
...
const AccessoriesPage: React.FC = () => {
  ...
  const { data: products, isLoading, error, refetch } = useQuery({
    ...
    queryFn: fetchAllAccessoriesProducts,
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <span className="text-lg">Loading accessories...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-lg mb-4">We're having trouble loading the accessories.</p>
          <button 
            onClick={() => refetch()}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Complete your look with our wide range of accessories. 
            From practical items to stylish additions, find everything you need here.
          </p>
        </div>
              ...
              <div className="mb-6">
                ...
                {activeTab === 'CATEGORY' && (
                  <div className="space-y-2 pl-4 max-h-48 overflow-y-auto">
                    {ACCESSORIES_SUBCATEGORIES.map((category) => (

...
// Subcategories for Custom Headwear
const HEADWEAR_SUBCATEGORIES = [
  'Headwear'
];

// Function to fetch products from all subcategories
const fetchAllHeadwearProducts = async (): Promise<any[]> => {
  try {
    const allProducts = [];
    
    for (const subcategory of HEADWEAR_SUBCATEGORIES) {
      try {
...
const CustomHeadwearPage: React.FC = () => {
  ...
  const { data: products, isLoading, error, refetch } = useQuery({
    queryKey: ['headwear-all'],
    queryFn: fetchAllHeadwearProducts,
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <span className="text-lg">Loading custom headwear...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-lg mb-4">We're having trouble loading the custom headwear.</p>
          <button 
            onClick={() => refetch()}
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Custom Headwear</h1>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Professional custom headwear for teams, businesses, and events. 
            From caps and beanies to specialized headwear with embroidery and printing options.
          </p>
        </div>
              ...
              <div className="mb-6">
                ...
                {activeTab === 'CATEGORY' && (
                  <div className="space-y-2 pl-4 max-h-48 overflow-y-auto">
                    {HEADWEAR_SUBCATEGORIES.map((category) => (

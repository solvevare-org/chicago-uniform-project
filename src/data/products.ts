...
export const getAccessoriesProducts = async (
  limit: number = 10
): Promise<Product[]> => {
  try {
    ...
    return Array.isArray(res.data.products)
      ? res.data.products.slice(0, limit)
      : [];
  } catch (error) {
    return [];
  }
...
export const getOuterwearProducts = async (
  limit: number = 10
): Promise<Product[]> => {
  try {
    const res = await axios.get(
...
export const getBrandsProducts = async (
  limit: number = 10
): Promise<Product[]> => {
  try {
    const res = await axios.get(
...
export const getHeadwearProducts = async (
  limit: number = 10
): Promise<Product[]> => {
  try {
    const res = await axios.get(
